...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate Non-Pipelined Systolic Array Testbench')
    ...
    # Non-Pipelined case: Vertical delay is 1 cycle (1 inter-PE register, 0 in PE)
    # Horizontal delay is 1 cycle (1 inter-PE register)
    generate_tb(args.rows, args.cols, args.k, args.out, vertical_delay=2, horizontal_delay=1)
